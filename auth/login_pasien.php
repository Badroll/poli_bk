          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center">Form Login Pasien</p>
                ...
                if(isset($_POST['login'])) {
                    ...
                    $sql_login = mysqli_query($con, "SELECT * FROM pasien WHERE no_ktp = '$user' AND password = '$pass'") or die (mysqli_error($con));
                    if(mysqli_num_rows($sql_login) > 0){
                      $pasien = mysqli_fetch_assoc($sql_login);
                       $_SESSION['pasien'] = $pasien;
                       header("Location: ../page_pasien");
                        exit;
                    }else { ?>
                        <div class="row">
                            <div class="col-lg-6-offset-3">
                                <div class="alert alert-danger alert-dismissable" role="alert">
                                    ...
                                    <strong>Login gagal</strong> No. KTP / password salah
                                </div>
                            </div>
                        </div>
                    <?php
                ...
                ?>
                  <div class="mb-3">
                    <label for="exampleInputusername" class="form-label">No. KTP</label>
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Belum penah mendaftar?</p>
                    <a class="text-primary fw-bold ms-2" href="<?=base_url("auth/register.php")?>">Daftar Akun</a><br>
                  </div>
