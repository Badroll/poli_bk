...
<?php
    ...
    $detail_periksa = mysqli_fetch_all(mysqli_query($con, "
        SELECT A.*, B.nama_obat as obat_nama_obat, B.kemasan as obat_kemasan, B.harga as obat_harga FROM detail_periksa as A JOIN obat as B ON A.id_obat = B.id
    "), MYSQLI_ASSOC);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mt-3 mb-3 col-md-12">
                                    ...
                                    <input type="text" class="form-control datepicker" name="tanggalFormat" id="tanggalFormat" disabled>
                                    <div class="form-text periksa-false"><i>*mohon tunggu hingga dokter memilih untuk dapat memberikan detail hasil periksa</i></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                        ...
                        <div class="row periksa-true">
                            <div class="col-md-6">
                                ...
                                <div class="mt-3 mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control" name="catatan" id="catatan" disabled><?php echo $periksa['periksa_catatan'] ?></textarea>
                                </div>
                            </div>
                            </form>
                            <div class="col-md-6">
